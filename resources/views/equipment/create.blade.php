...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="page-title">Tambah alatan sukan baru</h2>
                        ...
                        <form method="POST" action="{{ route('equipment.store') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label for="example-textarea">Maklumat Terperinci</label>
                                            <textarea class="form-control" id="example-textarea" name="description" rows="4"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div>
